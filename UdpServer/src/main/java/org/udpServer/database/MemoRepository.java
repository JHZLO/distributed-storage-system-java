package org.udpServer.database;
...
public class MemoRepository {
    ...
    public static String createNote(Connection connection, JSONObject jsonRequest) throws SQLException {
    ...
    public static String updateNote(Connection connection, int id, JSONObject jsonRequest) throws SQLException {
    ...
    public static String patchNote(Connection connection, int id, JSONObject jsonRequest) throws SQLException {
